...
\revisedApJ{This stellar mass is comparable to the median $\log M^* = 9.4$~\Msol\ for the 
lensed sample with H$\alpha$ measurements from \citet{Livermore:2015ck}.}
...
\revisedApJ{modeling each clump as a Gaussian 
...
In Figure~\ref{fig:surfacedensity}, we consider the surface density of star formation
...
samples of  \citet{Swinbank:2012gs} and %WiggleZ 
...
\revisedApJ{SINGS sample \citep{Kennicutt:2003jt} comparison sample, and 
comparable to those observed in the $z\sim 0$ \citet{Fisher:2016jp} sample.}
...
Figure~\ref{fig:sfr_distrib} shows \revisedApJ{reasonably good agreement}, 
...
indicates the value of expanding such comparisons to larger samples of lensed galaxies.
 ...
 The distribution function of clump size \revisedApJ{(Figure~\ref{fig:size_distrib})} 
...
$z=0$ comparison sample \revisedApJ{may have} exaggerated 
...
using 140-orbits of \hst\ \revisedApJ{per cluster}.
...
\revisedApJ{This Letter examines just one of the $\sim70$ SGAS lensed galaxies 
...
\begin{figure*}
\includegraphics[width=6.7in,angle=0]{f1.pdf} %Figs/PRfig1_try2.png}
\caption{The lensed galaxy \arcnamelong . The left panel shows
...
\begin{figure*}
\includegraphics[width=6.5in,angle=0]{f2.pdf} %{Figs/SFR_vs_size_606_Mar10.pdf}
...
\revisedApJ{Diagonal dashed lines show the best fit relations in four redshift bins
from \citet{Livermore:2015ck}.}
...
\revisedApJ{Of the two$z\sim0$ samples, \citet{Kennicutt:2003jt}  was chosen 
to represent ``normal'' galaxies, while \citet{Fisher:2016jp} have  
...
\begin{figure*}
\includegraphics[width=6in]{f3.pdf} %{Figs/SFR_distribution_liu.pdf} 
...
universe \citep{Liu:2013fw}, measured using Paschen $\alpha$, %from Figures 10 and 11 
 and normalized by the number of galaxies.
}\label{fig:sfr_distrib}
\end{figure*}


\begin{figure*}
\includegraphics[width=6in]{f4.pdf} %{Figs/size_distribution_liu.pdf}
...
Radii from the $z\sim0$ comparison sample \citep{Liu:2013fw} are 
isophotal  from HIIphot \citep{Thilker:2000dt}.
